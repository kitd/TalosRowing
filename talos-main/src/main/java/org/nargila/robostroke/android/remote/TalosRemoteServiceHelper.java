...
class TalosRemoteServiceHelper {
    ...
    private final static Map<String, Pair<String, String>> serviceClassMap = new HashMap<>();
    ...
    TalosRemoteServiceHelper(Context owner, String serviceId) throws ServiceNotExist {
     ...
     */
    private Intent getServiceIntent(boolean serviceInitIntent) {

...
public class StrokeAnalysisGraphSingle extends SensorGraphBase {
    ...
    private final SensorDataSink rollSink = new SensorDataSink() {
    ...
    private final SensorDataSink accelSink = new SensorDataSink() {
    ...
    public StrokeAnalysisGraphSingle(UILiaison factory, RoboStroke roboStroke) {
        ...
        CyclicArrayXYSeries rollSeries = new CyclicArrayXYSeries(XMode.GROWING, new XYSeries.Renderer(rollGraphPaint)) {
            {
                setIndependantYAxis(true);

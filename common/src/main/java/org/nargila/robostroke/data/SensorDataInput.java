...
public interface SensorDataInput {
     ...
     */
    SensorDataSource getGPSDataSource();
     ...
     * @return sensor data source
     */
    SensorDataSource getAccelerometerDataSource();
     ...
     * @return sensor data source
     */
    SensorDataSource getOrientationDataSource();
     ...
     */
    void skipReplayTime(float velocityX);

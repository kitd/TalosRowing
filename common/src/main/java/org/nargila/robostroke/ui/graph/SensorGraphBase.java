...
public abstract class SensorGraphBase extends LineGraph {
    ...
    final XYSeries accelSeries;
    final RoboStroke roboStroke;
    final SensorDataSink accelDataSink = new SensorDataSinkQueue(DATA_QUEUE_SIZE);
    private boolean attached;

    SensorGraphBase(UILiaison factory, XYSeries.XMode xMode, float xRange, float yRange, RoboStroke roboStroke) {
    ...
    private class SensorDataSinkQueue extends Thread implements SensorDataSink {
        ...
        SensorDataSinkQueue(int queueSize) {

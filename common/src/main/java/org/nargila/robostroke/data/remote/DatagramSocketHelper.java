...
class DatagramSocketHelper {
    ...
    private static void sendData(DatagramSocket socket, InetSocketAddress socketAddress, String s) throws IOException {
    ...
    private static DatagramPacket receivePacket(DatagramSocket socket, byte[] buf) throws IOException {
    ...
    private void joinMulticastGroup(MulticastSocket s) throws IOException {
...

        {
            ...
            while (enumeration.hasMoreElements()) {
                ...
                logger.debug("interface {}:  lo={}, ppp={}, up={}, virt={}, multicast={} - {}", i.getDisplayName(), i.isLoopback(), i.isPointToPoint(), i.isUp(), i.isVirtual(), i.supportsMulticast(), i);

...
public abstract class SensorBinder implements BusEventListener {
    ...
    private final LinkedList<SensorDataSourceBinder> sourceBinderList = new LinkedList<>();

    protected SensorBinder(RoboStroke roboStroke) {

...
public final class ClockTime implements Comparable<ClockTime>, Serializable {
    ...
    // Static variables
    //
    private final static ClockTime NONE = new ClockTime(-1, TimeUnit.NANOSECONDS);
    private final static ClockTime ZERO = new ClockTime(0, TimeUnit.NANOSECONDS);
     ...
     * @return The new ClockTime object.
     */
    private static ClockTime valueOf(long time, TimeUnit units) {
     ...
     * @return The new ClockTime object.
     */
    private static ClockTime valueOf(String timestamp) {
     ...
     */
    private long convertTo(TimeUnit unit) {
    ...
    public String toString() {
        ...
        return (hours > 9 ? "" : "0") + getHours() + ":" +
                (minutes > 9 ? "" : "0") + minutes + ":" +
                (seconds > 9 ? "" : "0") + seconds + "," +
                (millis > 99 ? "" : (millis > 9 ? "0" : "00")) + millis;
    }

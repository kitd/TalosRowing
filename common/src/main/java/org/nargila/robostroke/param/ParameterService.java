...
public class ParameterService {
    ...
    private final HashMap<String, HashSet<ParameterChangeListener>> listeners = new HashMap<>();

    private final HashMap<String, Parameter> paramMap = new HashMap<>();
    ...
    public ParameterService(RoboStrokeEventBus bus) {
        ...
        eventBus.addBusListener(new BusEventListener() {
            ...
            public void onBusEvent(DataRecord event) {
                if (event.type == DataRecord.Type.PARAMETER_CHANGE) {
    ...
    private synchronized void removeListener(String paramId, ParameterChangeListener listener) {
    ...
    public synchronized void setParam(Parameter param, Object value) {
        ...
        if (getParam(param.getId()) != param) {
            throw new IllegalArgumentException("parameter provided with id %s is not the same as the registered one");
        }
    ...
    private void onParamChanged(Parameter param) {
        ...
        HashSet<ParameterChangeListener> allListeners = new HashSet<>();

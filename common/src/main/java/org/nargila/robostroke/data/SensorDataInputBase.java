...
public abstract class SensorDataInputBase implements SensorDataInput {
    ...
    protected final SensorDataSource gpsDataSource = new SensorDataSource();
    protected final SensorDataSource accelerometerDataSource = new SensorDataSource();
    protected final SensorDataSource orientationDataSource = new SensorDataSource();
    ErrorListener errorListener;

    protected SensorDataInputBase() {
        super();
    }

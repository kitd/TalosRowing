...
public class LineGraph implements UpdatableGraphBase {
    ...
    MultiXYSeries multySeries;
    boolean positiveOnly = false;
    private double yRangeMin;
    private double yRangeMax = Double.MAX_VALUE;
    private boolean disabled = true;

    LineGraph(final UILiaison uiLiaison, double xRange, XYSeries.XMode xMode, double yScale,
    ...
    void drawGraph(RSCanvas canvas, RSRect rect, double xAxisSize,
                   double yAxisSize) {
    ...
    void drawSeries(RSCanvas canvas, RSRect rect, double xAxisSize,
    ...
    private void drawGrid(RSCanvas canvas, double yAxisSize, RSRect rect) {
        float y;
    ...
    void drawCentreLine(RSCanvas canvas, RSRect rect) {

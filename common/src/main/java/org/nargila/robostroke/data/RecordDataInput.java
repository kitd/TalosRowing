...
public abstract class RecordDataInput extends SensorDataInputBase {
    ...
    protected RecordDataInput(RoboStroke roboStroke) {
    ...
    protected void setSeakable(boolean seakable) {
     ...
     * @param pos
     */
    protected final void setPos(final double pos) {
        ...
        if (seakable) {
            ...
            new Thread("deffered seek job") {
                ...
                final long seekId = ++currenSeekId;
    ...
    void playRecord(DataRecord record) {
        switch (record.type) {
            case GPS:
    ...
    protected void playRecord(String line) {
        playRecord(line, null);
    }

    protected void playRecord(String line, String endOfRecMark) {
    ...
    private static class SensorQueueProcessor extends Thread {
        ...
        private final LinkedBlockingQueue<DataRecord> queue = new LinkedBlockingQueue<>();
        ...
        SensorQueueProcessor(String name, SensorDataSource sensorDataSource, int queueSize) {

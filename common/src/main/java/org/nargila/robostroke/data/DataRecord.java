    ...
    public enum Type {
        ...
        RECORDING_COUNTDOWN(false, new DataRecordSerializer() {
            ...
            protected String doSerialize(Object data) {
                ...
                /* tag, countdown */
                return String.format(Locale.UK, "%s,%d", vals);
            }
        ...
        ROWING_STOP(false, new DataRecordSerializer() {
            ...
            protected String doSerialize(Object data) {
                ...
                return String.format(Locale.UK, "%d,%f,%d,%d,%d", vals);
            }
        ...
        Type(boolean isReplayableEvent, DataRecordSerializer dataParser) {
            this(isReplayableEvent, true, null, dataParser);
        }
        Type(boolean isReplayableEvent, boolean isBusEvent, DataExporter dataExporter, DataRecordSerializer dataParser) {
        ...
        private static final class DistanceEventSerializer extends DataRecordSerializer {
            ...
            protected String doSerialize(Object data) {
                ...
                return String.format(Locale.UK, "%d,%f", vals);
            }

...
public abstract class StrokeScannerBase extends SensorDataFilter {
    ...
    StrokeScannerBase(RoboStrokeEventBus bus, float amplitudeFilterFactor) {
        this.bus = bus;
    ...
    void setAmplitudeFiltering(float factor) {
    ...
    void setAmplitudeChangeAcceptFactor(float factor) {
    ...
    void setAmplitudeChangeDamperFactor(float factor) {

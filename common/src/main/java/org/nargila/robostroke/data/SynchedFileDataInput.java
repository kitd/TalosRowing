...
public class SynchedFileDataInput extends FileDataInput {
    ...
    private final TreeMap<Long /* timestamp */, Long /* file byte offset */> time2offsets = new TreeMap<>();
    private final TreeMap<Long /* timestamp */, Long /* file byte offset */> offsets2time = new TreeMap<>();

    protected SynchedFileDataInput(RoboStroke roboStroke, File dataFile, long startTime, int coundDownId) throws IOException {
